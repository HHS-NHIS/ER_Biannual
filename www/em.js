      ...
      if(isTrend) {
       ...
       // hovertemplate= "hovertemplate";
        ...
        //layout.xaxis = x.length < 5 ? {tickvals: x_values,  title: 'Year'} : {};
          layout.xaxis = x.length < 15 ? { tickangle: -45, tickvals: x_values, ticktext: x_names, title: 'Year'} : {};
    ...
    $(document).on('updateNotes', function() {
      ...
      $(document).on('updateNotes', function () {
         ...
         //     ". Generated interactively: " + today.toDateString() + ".";
          ...
          var newCitation = NCHS + ". " + tableCaption + ". " + NHIS +
              ". Generated interactively: " + today3 + " from https://wwwn.cdc.gov/NHISDataQueryTool/ER_Biannual/index_biannual.html";
