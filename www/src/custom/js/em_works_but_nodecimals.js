  ...
  // TABLE TAB ------------------------------------------------------------------
    ...
    $(document).on('updatePlot', function() {
      ...
      if(isTrend) {
        ...
        hideYaxis = false;
        layout.yaxis = {tickformat: '0,.5', hoverformat: hoverfmt,  title: 'Value B'};
        layout.margin.l = 60;
    ...
    $(document).on('updateNotes', function() {
      ...
      fullCaption2 = newCaption2;
      fullCaption3 = newCaption3;
      
      var tableCaption = showSEs ? fullCaption :
        fullCaption.replace(" (standard errors)", "");
      $('#table-caption').text(tableCaption);
      
       var tableCaption2 = showSEs ? fullCaption2 :
         fullCaption2.replace(" (standard errors)", "");
       $('#table-caption2').text(tableCaption2);

       var tableCaption3 = showSEs ? fullCaption3 :
         fullCaption3.replace(" (standard errors)", "");
